...
setwd("C:/Users/lrowley/OneDrive - University of Edinburgh/Published Paper GitHub Repositories/Frailty and Social Risks/Analysis")
rm(list = ls())

male_estimates<- read_excel(path = "../Model Results/Model 1.xlsx")%>%
  mutate(Sex = "Men")

female_estimates<- read_excel(path = "../Model Results/Model 2.xlsx")%>%
  mutate(Sex = "Women")
...
ggsave("../Plots/Figure 1.png", units = "in", width = 7, height = 8, dpi = 500)