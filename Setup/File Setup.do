...
cd "C:\Users\lrowley\OneDrive - University of Edinburgh\Published Paper GitHub Repositories\New Frailty and Social Risks\Setup"
...
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 1.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_2_core_data_v4.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 2.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_3_elsa_data_v4.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 3.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_4_elsa_data_v3.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 4.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_5_elsa_data_v4.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 5.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_6_elsa_data_v2.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 6.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_7_elsa_data.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 7.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_8_elsa_data_eul_v2.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 8.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_9_elsa_data_eul_v1.dta", clear
rename *, lower
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\Main Data\ELSA Wave 9.dta"
...
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 1.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_2_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 2.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_3_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 3.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_4_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 4.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_5_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 5.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_6_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 6.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_7_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 7.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_8_elsa_financial_dvs_eul_v1.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 8.dta"

use "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\wave_9_financial_derived_variables.dta", clear
save "..\Data\Raw Data\UKDA-5050-stata\stata\stata13_se\IFS Data\ELSA IFS Financial Wave 9.dta"
